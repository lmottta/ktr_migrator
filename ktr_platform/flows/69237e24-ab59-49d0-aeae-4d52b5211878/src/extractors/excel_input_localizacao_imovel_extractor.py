...
class ExcelInputLocalizacaoImovelPipelineExtractor:
    """
    Extractor para: Excel_input_localizacao_imovel
    Tipo: ExcelInput
    """
    ...
    def extract(self) -> pd.DataFrame:
        ...
        """
        logger.info(f"🔄 Iniciando extração: Excel_input_localizacao_imovel")
        ...
        try:
            ...
            logger.error(f"❌ Erro na extração Excel_input_localizacao_imovel: {e}")
            raise

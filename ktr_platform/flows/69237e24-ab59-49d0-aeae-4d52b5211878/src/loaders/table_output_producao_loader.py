...
class TableoutputproducaoPipelineLoader:
    """
    Loader para: Table output PRODUCAO
    Tipo: TableOutput
    """
    ...
    def load(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        """
        logger.info(f"🔄 Iniciando carga: Table output PRODUCAO")
        ...
        try:
            ...
            return {
                ...
                "target": "Table output PRODUCAO"
            }
            
        except Exception as e:
            logger.error(f"❌ Erro na carga Table output PRODUCAO: {e}")
            raise

...
class TableinputdocumentoPipelineExtractor:
    """
    Extractor para: Table input documento
    Tipo: TableInput
    """
    ...
    def extract(self) -> pd.DataFrame:
        ...
        """
        logger.info(f"🔄 Iniciando extração: Table input documento")
        ...
        try:
            ...
            logger.error(f"❌ Erro na extração Table input documento: {e}")
            raise

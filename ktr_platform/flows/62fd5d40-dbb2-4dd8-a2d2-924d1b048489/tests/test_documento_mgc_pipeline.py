"""
Testes para pipeline documento_mgc
"""
import pytest
import pandas as pd
from unittest.mock import Mock, patch

from src.pipelines.documento_mgc_pipeline import DocumentoMgcPipeline

class TestDocumentoMgcPipeline:
    """Testes do pipeline documento_mgc"""
    ...
    def setup_method(self):
        ...
        self.pipeline = DocumentoMgcPipeline(self.config)

"""
Testes para pipeline importatabelas
"""
import pytest
import pandas as pd
from unittest.mock import Mock, patch

from src.pipelines.importatabelas_pipeline import ImportatabelasPipeline

class TestImportatabelasPipeline:
    """Testes do pipeline importatabelas"""
    ...
    def setup_method(self):
        ...
        self.pipeline = ImportatabelasPipeline(self.config)

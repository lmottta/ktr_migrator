...
class OFormacobrancaPipelineLoader:
    """
    Loader para: o_formacobranca
    Tipo: TableOutput
    """
    ...
    def load(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        """
        logger.info(f"🔄 Iniciando carga: o_formacobranca")
        ...
        try:
            ...
            return {
                ...
                "target": "o_formacobranca"
            }
            
        except Exception as e:
            logger.error(f"❌ Erro na carga o_formacobranca: {e}")
            raise

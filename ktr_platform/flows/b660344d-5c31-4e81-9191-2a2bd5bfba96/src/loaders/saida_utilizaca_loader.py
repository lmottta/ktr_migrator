...
class SaidaUtilizacaPipelineLoader:
    """
    Loader para: saida_utilizaca
    Tipo: TableOutput
    """
    ...
    def load(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        """
        logger.info(f"🔄 Iniciando carga: saida_utilizaca")
        ...
        try:
            ...
            return {
                ...
                "target": "saida_utilizaca"
            }
            
        except Exception as e:
            logger.error(f"❌ Erro na carga saida_utilizaca: {e}")
            raise

...
class OFormaaquisicaoPipelineLoader:
    """
    Loader para: o_formaaquisicao
    Tipo: TableOutput
    """
    ...
    def load(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        """
        logger.info(f"🔄 Iniciando carga: o_formaaquisicao")
        ...
        try:
            ...
            return {
                ...
                "target": "o_formaaquisicao"
            }
            
        except Exception as e:
            logger.error(f"❌ Erro na carga o_formaaquisicao: {e}")
            raise

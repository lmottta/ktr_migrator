...
class SaidaReceitaPipelineLoader:
    """
    Loader para: saida_receita
    Tipo: TableOutput
    """
    ...
    def load(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        """
        logger.info(f"🔄 Iniciando carga: saida_receita")
        ...
        try:
            ...
            return {
                ...
                "target": "saida_receita"
            }
            
        except Exception as e:
            logger.error(f"❌ Erro na carga saida_receita: {e}")
            raise

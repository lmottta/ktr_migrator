...
class OCriticasimagensPipelineLoader:
    """
    Loader para: o_criticasimagens
    Tipo: TableOutput
    """
    ...
    def load(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        """
        logger.info(f"🔄 Iniciando carga: o_criticasimagens")
        ...
        try:
            ...
            return {
                ...
                "target": "o_criticasimagens"
            }
            
        except Exception as e:
            logger.error(f"❌ Erro na carga o_criticasimagens: {e}")
            raise

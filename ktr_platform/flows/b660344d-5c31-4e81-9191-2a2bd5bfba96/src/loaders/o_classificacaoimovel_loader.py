...
class OClassificacaoimovelPipelineLoader:
    """
    Loader para: o_classificacaoimovel
    Tipo: TableOutput
    """
    ...
    def load(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        """
        logger.info(f"🔄 Iniciando carga: o_classificacaoimovel")
        ...
        try:
            ...
            return {
                ...
                "target": "o_classificacaoimovel"
            }
            
        except Exception as e:
            logger.error(f"❌ Erro na carga o_classificacaoimovel: {e}")
            raise

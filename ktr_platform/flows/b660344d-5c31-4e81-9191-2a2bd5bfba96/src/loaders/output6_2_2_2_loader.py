...
class Output6222PipelineLoader:
    """
    Loader para: output6 2 2 2
    Tipo: TableOutput
    """
    ...
    def load(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        """
        logger.info(f"🔄 Iniciando carga: output6 2 2 2")
        ...
        try:
            ...
            return {
                ...
                "target": "output6 2 2 2"
            }
            
        except Exception as e:
            logger.error(f"❌ Erro na carga output6 2 2 2: {e}")
            raise

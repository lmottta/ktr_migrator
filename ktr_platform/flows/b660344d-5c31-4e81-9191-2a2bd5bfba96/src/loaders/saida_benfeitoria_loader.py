...
class SaidaBenfeitoriaPipelineLoader:
    """
    Loader para: saida_benfeitoria
    Tipo: TableOutput
    """
    ...
    def load(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        """
        logger.info(f"🔄 Iniciando carga: saida_benfeitoria")
        ...
        try:
            ...
            return {
                ...
                "target": "saida_benfeitoria"
            }
            
        except Exception as e:
            logger.error(f"❌ Erro na carga saida_benfeitoria: {e}")
            raise

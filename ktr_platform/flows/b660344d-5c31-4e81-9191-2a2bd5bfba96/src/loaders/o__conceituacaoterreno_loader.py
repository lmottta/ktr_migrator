...
class OConceituacaoterrenoPipelineLoader:
    """
    Loader para: o_ conceituacaoterreno
    Tipo: TableOutput
    """
    ...
    def load(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        """
        logger.info(f"🔄 Iniciando carga: o_ conceituacaoterreno")
        ...
        try:
            ...
            return {
                ...
                "target": "o_ conceituacaoterreno"
            }
            
        except Exception as e:
            logger.error(f"❌ Erro na carga o_ conceituacaoterreno: {e}")
            raise

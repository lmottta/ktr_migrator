...
class Campos1PipelineTransformer:
    """
    Transformer para: campos1
    Tipo: SelectValues
    """
    ...
    def transform(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        """
        logger.info(f"🔄 Iniciando transformação: campos1")
        ...
        try:
            ...
            df['transformation_applied'] = 'campos1'
            ...
            logger.error(f"❌ Erro na transformação campos1: {e}")
            raise

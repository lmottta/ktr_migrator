...
class Campos5PipelineTransformer:
    """
    Transformer para: campos5
    Tipo: SelectValues
    """
    ...
    def transform(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        """
        logger.info(f"🔄 Iniciando transformação: campos5")
        ...
        try:
            ...
            df['transformation_applied'] = 'campos5'
            ...
            logger.error(f"❌ Erro na transformação campos5: {e}")
            raise

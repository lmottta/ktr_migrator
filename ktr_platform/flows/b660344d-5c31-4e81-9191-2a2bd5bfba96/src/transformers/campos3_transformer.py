...
class Campos3PipelineTransformer:
    """
    Transformer para: campos3
    Tipo: SelectValues
    """
    ...
    def transform(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        """
        logger.info(f"🔄 Iniciando transformação: campos3")
        ...
        try:
            ...
            df['transformation_applied'] = 'campos3'
            ...
            logger.error(f"❌ Erro na transformação campos3: {e}")
            raise

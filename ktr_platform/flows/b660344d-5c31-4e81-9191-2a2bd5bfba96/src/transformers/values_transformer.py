...
class ValuesPipelineTransformer:
    """
    Transformer para: values
    Tipo: SelectValues
    """
    ...
    def transform(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        """
        logger.info(f"🔄 Iniciando transformação: values")
        ...
        try:
            ...
            df['transformation_applied'] = 'values'
            ...
            logger.error(f"❌ Erro na transformação values: {e}")
            raise

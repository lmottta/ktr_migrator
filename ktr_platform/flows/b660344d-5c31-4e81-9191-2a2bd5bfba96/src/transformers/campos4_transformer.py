...
class Campos4PipelineTransformer:
    """
    Transformer para: campos4
    Tipo: SelectValues
    """
    ...
    def transform(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        """
        logger.info(f"🔄 Iniciando transformação: campos4")
        ...
        try:
            ...
            df['transformation_applied'] = 'campos4'
            ...
            logger.error(f"❌ Erro na transformação campos4: {e}")
            raise

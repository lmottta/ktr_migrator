...
class Campos6PipelineTransformer:
    """
    Transformer para: campos6
    Tipo: SelectValues
    """
    ...
    def transform(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        """
        logger.info(f"🔄 Iniciando transformação: campos6")
        ...
        try:
            ...
            df['transformation_applied'] = 'campos6'
            ...
            logger.error(f"❌ Erro na transformação campos6: {e}")
            raise

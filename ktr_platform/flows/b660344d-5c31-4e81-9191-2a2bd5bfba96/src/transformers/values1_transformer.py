...
class Values1PipelineTransformer:
    """
    Transformer para: values1
    Tipo: SelectValues
    """
    ...
    def transform(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        """
        logger.info(f"🔄 Iniciando transformação: values1")
        ...
        try:
            ...
            df['transformation_applied'] = 'values1'
            ...
            logger.error(f"❌ Erro na transformação values1: {e}")
            raise

...
class Values6PipelineTransformer:
    """
    Transformer para: values6
    Tipo: SelectValues
    """
    ...
    def transform(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        """
        logger.info(f"🔄 Iniciando transformação: values6")
        ...
        try:
            ...
            df['transformation_applied'] = 'values6'
            ...
            logger.error(f"❌ Erro na transformação values6: {e}")
            raise

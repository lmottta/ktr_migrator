...
class FormaaquisicaoPipelineExtractor:
    """
    Extractor para: formaaquisicao
    Tipo: TableInput
    """
    ...
    def extract(self) -> pd.DataFrame:
        ...
        """
        logger.info(f"🔄 Iniciando extração: formaaquisicao")
        ...
        try:
            ...
            logger.error(f"❌ Erro na extração formaaquisicao: {e}")
            raise

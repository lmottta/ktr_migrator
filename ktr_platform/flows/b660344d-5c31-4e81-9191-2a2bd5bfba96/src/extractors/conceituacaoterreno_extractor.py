...
class ConceituacaoterrenoPipelineExtractor:
    """
    Extractor para: conceituacaoterreno
    Tipo: TableInput
    """
    ...
    def extract(self) -> pd.DataFrame:
        ...
        """
        logger.info(f"🔄 Iniciando extração: conceituacaoterreno")
        ...
        try:
            ...
            logger.error(f"❌ Erro na extração conceituacaoterreno: {e}")
            raise

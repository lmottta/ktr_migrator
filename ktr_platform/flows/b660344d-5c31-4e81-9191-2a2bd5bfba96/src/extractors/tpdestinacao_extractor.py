...
class TpdestinacaoPipelineExtractor:
    """
    Extractor para: TpDestinacao
    Tipo: TableInput
    """
    ...
    def extract(self) -> pd.DataFrame:
        ...
        """
        logger.info(f"🔄 Iniciando extração: TpDestinacao")
        ...
        try:
            ...
            logger.error(f"❌ Erro na extração TpDestinacao: {e}")
            raise

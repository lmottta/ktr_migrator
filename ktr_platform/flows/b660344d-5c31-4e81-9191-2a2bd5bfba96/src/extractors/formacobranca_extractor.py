...
class FormacobrancaPipelineExtractor:
    """
    Extractor para: formacobranca
    Tipo: TableInput
    """
    ...
    def extract(self) -> pd.DataFrame:
        ...
        """
        logger.info(f"🔄 Iniciando extração: formacobranca")
        ...
        try:
            ...
            logger.error(f"❌ Erro na extração formacobranca: {e}")
            raise

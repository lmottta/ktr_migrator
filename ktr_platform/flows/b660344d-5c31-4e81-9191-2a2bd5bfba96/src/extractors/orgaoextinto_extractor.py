...
class OrgaoextintoPipelineExtractor:
    """
    Extractor para: orgaoextinto
    Tipo: TableInput
    """
    ...
    def extract(self) -> pd.DataFrame:
        ...
        """
        logger.info(f"🔄 Iniciando extração: orgaoextinto")
        ...
        try:
            ...
            logger.error(f"❌ Erro na extração orgaoextinto: {e}")
            raise

...
class ClassificacaoimovelPipelineExtractor:
    """
    Extractor para: classificacaoimovel
    Tipo: TableInput
    """
    ...
    def extract(self) -> pd.DataFrame:
        ...
        """
        logger.info(f"🔄 Iniciando extração: classificacaoimovel")
        ...
        try:
            ...
            logger.error(f"❌ Erro na extração classificacaoimovel: {e}")
            raise

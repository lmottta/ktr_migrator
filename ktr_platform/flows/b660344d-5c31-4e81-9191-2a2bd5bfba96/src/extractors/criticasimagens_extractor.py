...
class CriticasimagensPipelineExtractor:
    """
    Extractor para: criticasimagens
    Tipo: TableInput
    """
    ...
    def extract(self) -> pd.DataFrame:
        ...
        """
        logger.info(f"🔄 Iniciando extração: criticasimagens")
        ...
        try:
            ...
            logger.error(f"❌ Erro na extração criticasimagens: {e}")
            raise
